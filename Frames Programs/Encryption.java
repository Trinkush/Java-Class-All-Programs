...
public class Encryption extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Encrypted Notepad");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String text = "";
        String decryptedText = jTextField2.getText();
        int length = decryptedText.length();
        char[] arr = new char[length];
        for (int i = 0; i < decryptedText.length(); i++) {
            char charName = decryptedText.charAt(i);
            int charAscii = ((int) charName);
            ++charAscii;
            arr[i] = ((char) charAscii);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        String newtext = "";
        String encryptedText = jTextField3.getText();
        int length = encryptedText.length();
        char[] arra = new char[length];
        for (int i = 0; i < encryptedText.length(); i++) {
            char charName = encryptedText.charAt(i);
            int charAscii = ((int) charName);
            --charAscii;
            arra[i] = ((char) charAscii);

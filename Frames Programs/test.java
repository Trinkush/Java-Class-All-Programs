...
public class test extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            // obj.insert("insert into frames(firstName,lastName,userName)" + " values('firstName','lastName','userName')");
            //obj.insert("insert into information(id,name)" + " values(19,'java')"); 
            //obj.insert("INSERT INTO `frames` (`firstName`, `lastName`, `userName`) VALUES ('" + firstName + "', '" + lastName + "', '" + userName + "');");
            obj.insert("insert into frames values('" + firstName + "', '" + lastName + "' , '" + userName + "') ");
            new Next();
        } catch (Exception e) {
